...
\begin{figure}[!h]
    ...
    \caption{\label{fig:smiles} \textbf{Illustration of the mapping from chemical structure to SMILES.} The chemical structure of a molecule is divided into several `branches', which are shown in different colors. In SMILES, each branch is enclosed by parantheses. Adapted from \cite{Kim2021GenerativeCT}.}
\end{figure}
