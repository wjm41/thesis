...
\begin{table}[!h]
    \begin{center}
        ...
        \hline
             ...
             \hline
        \end{tabular}
        \caption{Demonstration of the SMARTS language}
        \label{table:smarts}
    \end{center}
\end{table}
