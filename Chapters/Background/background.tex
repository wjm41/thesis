...
% \caption[GRU for reaction predictions]{The architecture used by Nam and Kim. The input SMILES string is tokenized into ``words", each token is embedded using a learnt embedding and processed by a three-layer GRU network. The product is generated using an attention mechanism.}
% \label{fig:gru}
% \end{figure}
% \fi
