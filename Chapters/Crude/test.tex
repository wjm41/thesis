...
While the model is generally quite conservative in its predictions, it does identify a number of compounds with high predicted activity that are not active in the crude assay. We suspected that these were false negatives due to either the low yield of the crude reaction mixture or some other form of experimental noise. We identified 5 compounds with the largest positive difference between predicted and measured activity and re-synthesized, purified, and re-tested them with full dose-response curves to obtain IC50 inhibition values. This revealed that one of them was indeed potent with IC50 = $0.113\pm0.046$\uM (ASAP-0000204).

< Figure of the false negative > \# TODO
...
% Discuss compounds liked by the model?
...
Both sets of compounds exhibit similar distributions in bioactivity (Figure \ref{fig:strip}), with several compounds improving IC50 by up-to 300-fold on MAT-POS-4223bc15-21 (up-to 3-fold on the corresponding methyl-amide).

The top 2 ML compounds showed promising average IC50 values of 0.0525\uM (ASAP-0000169) and 0.075\uM (ASAP-0000211), respectively. Although the top 2 most potent crude compounds were slightly more potent with IC50 = 0.034\uM (ASAP-0000221) and IC50 = 0.064\uM (ASAP-0000164), they contain the toxic benzene-1,4-diamine motif that is generally avoided \cite{Kumar2011diallinine}. The top 2 crude compounds without the aforementioned motif had IC50s of 0.046\uM (ASAP-0000155) and 0.064\uM (ASAP-0000225), which are similar to the top 2 ML compounds.
