...
\begin{figure}[!t]
    ...
    \caption{\textbf{The bioactivity of the crude reaction mixtures is influenced by the yield of the nanomolar-scale reaction.} High yielding compounds are much likelier to exhibit high activity (strongly inhibiting Mpro) while low yielding compounds tend to have low activity.}
